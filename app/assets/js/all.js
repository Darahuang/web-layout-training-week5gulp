...
$(() => {
  ...
  // 新增資料的 modal
  $('.js_new_admin_btn').on('click', () => {
    $('.js_new_admin_modal').modal('show');
  });
  // 編輯資料的 modal
  $('.js_edit_admin_btn').on('click', () => {
    $('.js_edit_admin_modal').modal('show');
  });
  // 詳細資料的 modal
  $('.js_user_admin_btn').on('click', () => {
